...
\begin{figure}
	...
	\caption{
		CPU utilization during a run of the tri-dexel algorithm with a grid resolution of 200, all features enabled, reconstructing the surface of the \impeller scene.
	}
...
Problematic cases \Cref{fig:bpa_issues} shows cases for these two problems.
%
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.49\textwidth}
