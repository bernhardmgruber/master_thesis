...
\begin{description}
	...
	These points can be obtained \eg by sampling a solid's surface, either virtually using a raycast or in reality by scanning an objects surface, \eg laser scans of buildings, sculptures \etc.
