...
In chapter \ref{ch:fundamentals} a coverage of the most important terms related to solid modeling, meshes and virtual machining as well as a comprehensive list of wide-spread representations used in CAD and CAM are discussed.
...
Chapter \ref{ch:tri_dexel} describes the second implementation which is based on a tri-dexel representation.
...
Chapter \ref{ch:point_cloud_based} builds on the idea of the axis-aligned raycast to sample a point cloud of the VML's data model.
