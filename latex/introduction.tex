...
\Cref{ch:direct_intersection} discusses the first implemented approach to reconstruct a surface from the data model of the VML.
...
\Cref{ch:point_cloud_based} builds on the idea of the axis-aligned raycast to sample a point cloud of the data model of the VML.
