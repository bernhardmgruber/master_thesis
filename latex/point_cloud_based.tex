...
In the previous \cref{ch:tri_dexel}, the tri-dexel based surface reconstruction approach relied on a raycast to sample the regular grid of the VML into dexels.
