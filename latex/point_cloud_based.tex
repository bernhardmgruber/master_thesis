...
\begin{figure}
	...
	\caption[Example point cloud]{
		Point cloud created by raycasting the \cylinderhead scene using three axis-aligned raycasts along the coordinate system's axes with a resolution of 200.
	}
...
The raycast is launched with the calculated resolution and the grid's bounding box.
