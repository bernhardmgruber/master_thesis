...
\begin{description}
	...
	First described in 1983, vector clipping is mainly used in CAE to verify the correctness of a generated NC program before it is run on an actual milling machine \cite{vector_clipping}.
