...
\begin{description}
	...
	\begin{figure}[H]
		...
		\caption{
			...
			The mesh in image \subref{fig:non_manifold_edge} contains an edge with three incident triangles.
			The mesh in image \subref{fig:non_manifold_vertex} contains a non-fan triangle connected to a vertex.
			Image \subref{fig:t_vertex} shows the T-vertex problem:
...
\begin{description}
	...
	Figure \ref{fig:brep} shows an example of a B-rep which represents a machining part using triangles as faces.
	%
