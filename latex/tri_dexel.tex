...
Therefore, the same code can be used to create other data structures as well, \cf chapter \ref{ch:point_cloud_based}.
...
Three of these indices uniquely identify one of the cell's sides and are used as indices into another lookup table, \var{cellPlaneNormals}, storing the cell side's normal for each combination of three grid points. %TODO: add table
