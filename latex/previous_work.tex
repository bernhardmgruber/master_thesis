...
These cutting tools are solid triangle meshes, loaded from disk, which are moved along paths, \ie list of transformation matrices, to create swept volumes, \ie triangle meshes.
...
\begin{figure}
	...
	\caption{
		...
		A ray is sent from an eye point, \ie camera position, through each pixel of an image plane and is traversed through the scene.
