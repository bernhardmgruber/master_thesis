...
For testing the direct intersection approach and the further surface reconstruction algorithms shown in the following chapters, a few test scenes are proposed created.
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{
		MeshLab renderings of selected areas from the impeller \subref{fig:di_impeller_detail} and turbine \subref{fig:di_turbine_detail} scene after applying the direct intersection reconstruction approach.
	}
