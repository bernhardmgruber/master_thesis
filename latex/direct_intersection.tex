...
The CPU utilization during an single run of the direct intersection approach is shown in figure \ref{fig:di_cpu}.
%
\begin{figure}
	\centering
...
Figure \ref{fig:direct_intersection_results} contains renderings of the resulting triangle meshes.
...
\begin{figure}
	...
	\label{fig:direct_intersection_results}
\end{figure}
