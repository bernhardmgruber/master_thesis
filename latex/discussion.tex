...
Regarding the cell slicing enhancement in addition to the refinement of the original algorithm \cite{tri_dexel_reconstruction}, slicing irregular cells greatly reduces dropping valuable information during regularization, resulting in far better refined features.
...
The CPU utilization of the raycast used for creating the point cloud is discussed as part of the tri-dexel algorithm, \cf \cref{sec:tri_dexel_runtime}.
...
Concerning the rendered result meshes, \cf \cref{bpa_results}, all scenes except the \turbine have been extracted without errors.
...
The Poisson reconstruction, as the BPA, depends on a sufficient resolution of the point cloud, \cf the renderings of a groove of the \turbine in \cref{poi_grooves}.
